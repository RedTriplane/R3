...
import org.jbox2d.f.pooling.normal.MutableStack;
...
public class VoronoiDiagram {
  ...
  public void addGenerator(Vector2 center, int tag) {
  ...
  public void generate(float radius) {
    ...
    for (int k = 0; k < m_generatorCount; k++) {
      ...
      Vector2.minToOut(lower, g.center, lower);
      Vector2.maxToOut(upper, g.center, upper);
    }
