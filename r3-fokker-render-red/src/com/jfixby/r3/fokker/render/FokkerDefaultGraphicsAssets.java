...
import com.jfixby.r3.engine.api.render.DefaultGraphicsAssets;
import com.jfixby.r3.fokker.api.FOKKER_SYSTEM_ASSETS;
import com.jfixby.scarabei.api.collections.Collections;
import com.jfixby.scarabei.api.collections.List;
import com.jfixby.scarabei.api.names.ID;

public class FokkerDefaultGraphicsAssets implements DefaultGraphicsAssets {
	...
	FokkerDefaultGraphicsAssets () {
		RASTER_IS_MISING = (FOKKER_SYSTEM_ASSETS.RASTER_IS_MISING);
		BLACK = (FOKKER_SYSTEM_ASSETS.RASTER_BLACK);
		DEBUG_BLACK = (FOKKER_SYSTEM_ASSETS.RASTER_DEBUG_BLACK);
		GENERIC_FONT = (FOKKER_SYSTEM_ASSETS.FONT_GENERIC);
		LOGO = (FOKKER_SYSTEM_ASSETS.RASTER_LOGO);
