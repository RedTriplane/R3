...
public class FOKKER_SYSTEM_ASSETS {
	...
	public static String SHADER_GRAYSCALE = SHADERS + "." + "grayscale";
	public static String SHADER_GDX_DEFAULT = "com.badlogic.gdx.graphics.g2d.SpriteBatch.DefaultShader";
