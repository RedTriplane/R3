...
public class RedAndroidComponent implements AndroidComponent {
	Context context;
	private final RedTriplaneAndroidApplication app;
	private final RedAndroidCameraSetup cameraSetup;

	public RedAndroidComponent (final RedTriplaneAndroidApplication redTriplaneAndroidApplication) {
		this.app = redTriplaneAndroidApplication;
		this.context = redTriplaneAndroidApplication.getContext();
		this.cameraSetup = new RedAndroidCameraSetup(this.app);
	}
