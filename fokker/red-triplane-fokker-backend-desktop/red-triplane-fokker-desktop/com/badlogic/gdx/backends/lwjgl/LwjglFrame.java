...
public class LwjglFrame extends JFrame {
	...
	public LwjglFrame (ApplicationListener listener, FokkerLwjglApplicationConfiguration config) {
		super(config.title);
		construct(listener, config);
	}

	private void construct (ApplicationListener listener, FokkerLwjglApplicationConfiguration config) {
