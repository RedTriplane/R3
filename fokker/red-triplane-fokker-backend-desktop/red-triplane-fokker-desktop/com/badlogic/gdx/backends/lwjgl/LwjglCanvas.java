...
public class LwjglCanvas implements Application {
	...
	public LwjglCanvas (ApplicationListener listener, FokkerLwjglApplicationConfiguration config) {
		initialize(listener, config);
	}

	private void initialize (ApplicationListener listener, FokkerLwjglApplicationConfiguration config) {
		...
		if (!FokkerLwjglApplicationConfiguration.disableAudio) audio = new OpenALAudio();
