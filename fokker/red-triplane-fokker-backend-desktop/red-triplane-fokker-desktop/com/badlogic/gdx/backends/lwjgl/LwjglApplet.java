...
public class LwjglApplet extends Applet {
	final Canvas canvas;
	FokkerLwjglApplication app;

	class LwjglAppletApplication extends FokkerLwjglApplication {

		public LwjglAppletApplication (ApplicationListener listener, Canvas canvas) {
			super(listener, canvas);
		}

		public LwjglAppletApplication (ApplicationListener listener, Canvas canvas, FokkerLwjglApplicationConfiguration config) {
	...
	public LwjglApplet (final ApplicationListener listener, final FokkerLwjglApplicationConfiguration config) {
