...
public class LwjglAWTCanvas implements Application {
	...
	public LwjglAWTCanvas (ApplicationListener listener, FokkerLwjglApplicationConfiguration config) {
	...
	public LwjglAWTCanvas (ApplicationListener listener, FokkerLwjglApplicationConfiguration config,
		...
		if (config == null) config = new FokkerLwjglApplicationConfiguration();
		...
		if (!FokkerLwjglApplicationConfiguration.disableAudio && Gdx.audio == null) audio = new OpenALAudio();
