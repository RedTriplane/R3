...
public class LwjglGraphics implements Graphics {
	...
	FokkerLwjglApplicationConfiguration config;
	...
	LwjglGraphics (FokkerLwjglApplicationConfiguration config) {
		this.config = config;
	}

	LwjglGraphics (Canvas canvas) {
		this.config = new FokkerLwjglApplicationConfiguration();
		config.width = canvas.getWidth();
		config.height = canvas.getHeight();
		this.canvas = canvas;
	}

	LwjglGraphics (Canvas canvas, FokkerLwjglApplicationConfiguration config) {
		this.config = config;
		this.canvas = canvas;
	}
	...
	public interface SetDisplayModeCallback {
		...
		public FokkerLwjglApplicationConfiguration onFailure (FokkerLwjglApplicationConfiguration initialConfig);
	}
