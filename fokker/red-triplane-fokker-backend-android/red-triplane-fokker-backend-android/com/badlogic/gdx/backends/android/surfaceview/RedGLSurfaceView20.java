...
public class RedGLSurfaceView20 extends GLSurfaceView {
	...
	public RedGLSurfaceView20 (Context context, ResolutionStrategy resolutionStrategy, int targetGLESVersion) {
		super(context);
	...
	public RedGLSurfaceView20 (Context context, ResolutionStrategy resolutionStrategy) {
		this(context, resolutionStrategy, 2);
	}

	public RedGLSurfaceView20 (Context context, boolean translucent, int depth, int stencil, ResolutionStrategy resolutionStrategy) {
		super(context);
		this.resolutionStrategy = resolutionStrategy;
	...
	static class ContextFactory implements GLSurfaceView.EGLContextFactory {
		...
		public EGLContext createContext (EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
			...
			int[] attrib_list = {EGL_CONTEXT_CLIENT_VERSION, RedGLSurfaceView20.targetGLESVersion, EGL10.EGL_NONE};
