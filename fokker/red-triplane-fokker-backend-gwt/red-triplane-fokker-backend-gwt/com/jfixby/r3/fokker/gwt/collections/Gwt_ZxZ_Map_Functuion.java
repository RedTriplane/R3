...
public class Gwt_ZxZ_Map_Functuion<T> implements ZxZ_Functuion<T> {

	final Map<Gwt_ZxZ, T> mapping = Collections.newMap();

	@Override
	public T getValueAt(long x, long y) {

		{
			Gwt_ZxZ position = Gwt_ZxZ.newIndexedPosition(x, y);
